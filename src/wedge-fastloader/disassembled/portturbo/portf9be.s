...
FASTLOAD:
	...
	+parallel_port_input
        ...
        and     #$EF
        sta     TED_FF06
        lda     TED_BORDER	; E6 = original border color
        sta     $E6
        ldy     #$04
...
ReadGCRTrack:
LFAAB:  cmp     $D0			; do we have that track in buffer now?
        bne     +
        rts
...
ReadDecodeGCRSector:
LFB24:  lda     TED_BORDER		; toggle border color
        eor     #$F0
        sta     TED_BORDER
        lda     $D1
        jsr     ReadGCRTrack
